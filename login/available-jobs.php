...
<html lang="en">
  ...
  <div class="card">
    ...
    <div class="card-body">
      <h3 class="">Job title:<u> <?php echo $row['title']; ?> </u></h3>
     <h4><p class="card-text"><b>Description:</b> &nbsp<?php echo $row['descriptions']; ?>.</p></h4> 
     <h4><p class=" ">Location: &nbsp<?php echo $row['place']; ?>.</p></h4> 
     <h4><p class="card-text">Posted Date: &nbsp<?php echo $row['posting_date']; ?>.</p></h4> 
    </div>
    <div class="card-footer">
      <small class=""><p class="card-text">Posted Date: &nbsp<?php echo $row['posting_date']; ?>.</p></small>
	   &nbsp<a href=""> <small class=" ">See more</small></a>
    </div>
  </div>
  </div>
  </div>
