		...
		<!-- <div class="modal fade" id="Modal_login" role="dialog">
                ...
                <div class="modal fade" id="Modal_register" role="dialog">
					...
					<ul class="header-links">
                        <h2>
						<li><a href="../login/available-tender.php"><i class=" -users" aria-hidden="true"></i></i>Available Tenders</a></li>
						<li><a href="../login/add-tender.php"><i class=" -users" aria-hidden="true"></i></i>Post Tenders</a></li>
						<li><a href="../login/tender-expire.php"><i class=" -users" aria-hidden="true"></i></i>Expired Jobs</a></li>
						 <li><a href="../common/user-index.php">Back</a></li>	
                         </h2>		
					</ul>
