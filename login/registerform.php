...
if (preg_match("/^[a-zA-Z ]*$/",$member_id)) {
  $nameErr = "Only letters and white space allowed"; 
		...
		$profile_pic=test_input($_POST["profile_pic"]);
		$id_front = test_input($_POST["id_front"]);
		$id_back =test_input($_POST["id_back"]);
		$date=date("d-m-y");
...
// *****************************************Images upload code starts here********************************************************** 
		$profile_pic = $_FILES['profile_pic']['name'];$tmp_name=$_FILES['profile_pic']['tmp_name'];$path = "images/".$profile_pic;move_uploaded_file($tmp_name, $path);
...
// *****************************************Images upload code end here********************************************************** 
 		...
 		if ($run) {
            echo "Your Data has  been submitted to Adminn, Kindly be Patient as Admin is Processing your request";
			// header('location: .php');
 		}
 		else {
...
<link rel="stylesheet" type="text/css" href="../bootstrap/css/bootstrap.min.css">
      ...
      <form action="registerform.php" method = "POST" enctype="multipart/form-data">
	    ...
	    <div class="modal-content">
                                ...
                                <a href="login.php"  class="row g-6">Go back</a>
                            </div>    
                         </div>
								  		...
								  		<div class="row">
											<div class="col-md-4">
											    <div class="form-group">
											        ...
											        <input type="text"  autocomplete="off" name="member_id" class="form-control" maxlength =4 required >
											    </div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
											...
											<div class="col-md-4">
												<div class="form-group">
												    ...
												    <input type="email" name="member_email" class="form-control" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" required>
											    </div>
											</div>
								  		</div>
