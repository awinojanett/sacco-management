 ...
 .cadi{
	...
	while ($row=mysqli_fetch_array($run)) {
		?>
	        ...
	        while ($row=mysqli_fetch_array($run)) {
		          ?>
				                <img  style="border-radius:50%; text-align:center; height: 40px; width: 40px; display: inline-block;" src="../images/<?php echo $row['image']; ?>" alt="">
			...
			<div id="top-header">
				<div class="container">
					...
					<ul class="header-links pull-right">
						...
						<li><a href="../login/tenders.php"><i class="fa fa-handshake-o" aria-hidden="true"></i>Tenders</a></li>
						<li><?php
                            if(isset($_SESSION["unique_id"])){
                                ...
                                echo '
                               <div class="dropdownn">
                                  <a href="#" class="dropdownn" data-toggle="modal" data-target="#myModal" ><i class="fa fa-user-o"></i> Welcome, <b> '.$row['title'].' '.$row['first_name'].' </b> </a>
                                  <div class="dropdownn-content">
                                    <a href="profile.php" data-toggle="modal" data-target="#profile"><i class="fa fa-user-circle" aria-hidden="true" ></i>My Profile</a>
                                    <a href="../login/logout1.php"  ><i class="fa fa-sign-in" aria-hidden="true"></i>Log out</a>
		...
		<!-- <div class="modal fade" id="Modal_login" role="dialog">
                ...
                <div class="modal fade" id="Modal_register" role="dialog">
					  ...
					  <body>
					  <div class="col-md-6"> <h2> Nearby users</h2></div>
     ...
     <section class="users">
	  ...
	  <img  style=" height: 180px; width: 245px; display: inline-block;" src="../images/<?php echo $row['image']; ?>" alt="">
  <div class="card-body">
  
  </div>
  <ul class="list-group list-group-flush">
    <li class="list-group-item"><span><h4><?php echo $row['title']. " " .$row['first_name']. " " . $row['last_name'] ?><h4></span></li>
    <li class="list-group-item"><p><b>Home county: &nbsp &nbsp</b> <?php echo $row['home_county']; ?></p></li>
    <li class="list-group-item"> <p><b>Job title: &nbsp &nbsp &nbsp &nbsp </b> <?php echo $row['job_title']; ?></p></li>
    <li class="list-group-item"><p><b>Tell: &nbsp &nbsp &nbsp</b> 0<?php echo $row['phone_number']; ?></p></li>
  
    <div class="list-group list-group-flush">  &nbsp
    <a href="#" class="card-link"> Message</a>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
