	...
	<body>
		...
		<main role="main" class="col-xl-10 col-lg-9 col-md-8 ml-sm-auto px-md-4 w-100">
			<div class="sub-main">
				...
				<table id = "doc" class="w-100 table-elements mb-3 table-three-tr text-left" cellpadding="10">
		          ...
		          <td>'.$joining_date.'</td>
				  <td>'.$county.'</td>
				  <td><a href="delete-function.php"><button type="button" name = "btn_update" class="btn btn-success">Edit</button></a>   </td>
				 <td><a href="delete-function.php"><button type="button" class="btn btn-danger">Delete</button></a>   </td>
				  </td>
                  </tr>';
                     }
                   }
